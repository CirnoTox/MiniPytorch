...
import numpy
from mpt import utility as init
...
class TensorTuple(Value):
    ...
    def __getitem__(self, index: int):
        return mpt.ops.tuple_get_item(self, index)

    def tuple(self):
        return tuple([x for x in self])

    def __repr__(self):
        return "mpt.TensorTuple" + str(self.tuple())
    ...
    def __add__(self, other):
        ...
        return mpt.ops.make_tuple(*[self[i] + other[i] for i in range(len(self))])
...
class Tensor(Value):
    ...
    def __repr__(self):
        return "mpt.Tensor(" + str(self.realize_cached_data()) + ")"
    ...
    def __add__(self, other):
        if isinstance(other, Tensor):
            return mpt.ops.EWiseAdd()(self, other)
        else:
            return mpt.ops.AddScalar(other)(self)

    def __mul__(self, other):
        if isinstance(other, Tensor):
            return mpt.ops.EWiseMul()(self, other)
        else:
            return mpt.ops.MulScalar(other)(self)

    def __pow__(self, other):
        return mpt.ops.PowerScalar(other)(self)

    def __sub__(self, other):
        if isinstance(other, Tensor):
            return mpt.ops.EWiseAdd()(self, mpt.ops.Negate()(other))
        else:
            return mpt.ops.AddScalar(-other)(self)

    def __rsub__(self, other):
        if isinstance(other, Tensor):
            return mpt.ops.EWiseAdd()(mpt.ops.Negate()(self), other)
        else:
            return mpt.ops.AddScalar(other)(-self)

    def __truediv__(self, other):
        if isinstance(other, Tensor):
            return mpt.ops.EWiseDiv()(self, other)
        else:
            return mpt.ops.DivScalar(other)(self)

    def __matmul__(self, other):
        return mpt.ops.MatMul()(self, other)

    def matmul(self, other):
        return mpt.ops.MatMul()(self, other)

    def sum(self, axes=None):
        return mpt.ops.Summation(axes)(self)

    def broadcast_to(self, shape):
        return mpt.ops.BroadcastTo(shape)(self)

    def reshape(self, shape):
        return mpt.ops.Reshape(shape)(self)

    def __neg__(self):
        return mpt.ops.Negate()(self)

    def transpose(self, axes=None):
        return mpt.ops.Transpose(axes)(self)
    
    ### SELF DEFINED
    def tanh(self):
        return mpt.ops.Tanh()(self)
...
def compute_gradient_of_variables(output_tensor, out_grad):
    ...
    # https://github.com/bettersemut/dlsys_hw2/blob/8b16e4ecac6cf5d5efb2c4840f9107cdfe64e00b/python/mpt/autograd.py#L420
